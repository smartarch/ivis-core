...
export default class AnimationSamplePanel3 extends Component {
    render() {
        const panelParams = {
            type: 'client',
            beginTs: Date.parse('2017-01-01T02:00:00.000Z'),
            endTs: Date.parse('2017-01-01T02:59:50.000Z'),
        ...
        return (
            <TestWorkspacePanel
                title="Client Animation: Panel 3"
                panel={{}}
                params={panelParams}
